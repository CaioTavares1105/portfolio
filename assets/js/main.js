...
function updateLanguagens(profileData) {
...
function uppdateExperience(profileData) {
    const formation = document.getElementById('profile.formation')
    formation.innerHTML = profileData.formation.map(experience => {
...
(async () => {
    ...
    updateLanguagens(profileData)
    updatePortfolio(profileData)
    uppdateExperience(profileData)
